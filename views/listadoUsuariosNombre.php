    ...
    <main class="container py-5">
        ...
        <div class="container">
            ...
            <div class="container text-end mb-3">
                <a href="./listadoUsuarios.php" class="btn btn-dark"><i class='fas fa-arrow-left'></i> Volver al Listado</a>
            </div>
            ...
            $seachUserNombre = $_POST['seachUserNombre'];

            $listUsers = $usuarioDAO->listarUsuariosPorNombre($seachUserNombre);
            if (empty($listUsers)) {
