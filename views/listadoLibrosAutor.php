...
<body>
    ...
    <main class="container py-5">
        ...
        <div class="container">
            ...
            <?php
            if (empty($_POST['seachBookAuthor'])) {
                echo "<h4>Busqueda por Título: ' '</h4>";
            } else {
                echo "<h4>Busqueda por Título: ' " . $_POST['seachBookAuthor'] . " '</h4>";
            }
            ...
            if (empty($_POST['seachBookAuthor'])) {
                ...
                echo "<div class='alert alert-danger text-center' role='alert'> Introduce texto en la búsqueda</div>";
                echo "</div>";
            } else {
                $seachBookAutor = $_POST['seachBookAuthor'];
                $listLibrosAutor = $libroDAO->listarLibrosporAutor($seachBookAutor);
                if (empty($listLibrosAutor)) {
                    echo "<div class='w-50 mx-auto'>";
                    echo "<div class='alert alert-danger text-center' role='alert'> No se encontraron resultados a tu búsqueda</div>";
                    echo "</div>";
                } else {
                    ...
                    echo "</thead>";
                    echo "<tbody>";
                    foreach ($listLibrosAutor as $libro) {
                        echo "<tr>";
                        ...
                        echo "<td>";
                        echo $libro->getCountry();
                        echo "</td>";

                        echo "<td>";
                        echo $libro->getLanguage();
                        echo "</td>";
