...
<body>
    ...
    <main class="container py-5">
        ...
        <div class="container">
            ...
            <?php
            echo "<h4>Busqueda de libros con stock menor a: ' " . $_POST['seachBookStock'] . " '</h4>";
            ?>
            ...
            $seachBookStock = $_POST['seachBookStock'];

            $listLibrosStock = $libroDAO->listarLibrosporStock($seachBookStock);
            if (empty($listLibrosStock)) {
                ...
                echo "</thead>";
                echo "<tbody>";
                foreach ($listLibrosStock as $libro) {
                    echo "<tr>";
