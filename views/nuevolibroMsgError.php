        ...
        <div class="container">
            <div class="modal" tabindex="-1" id="modalProyecto">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content modal-content-loginError">
                        <div class="modal-header">
                            <h4 class="modal-title text-danger"><i class="fas fa-times-circle"></i> Ha ocurrido un error</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <p>Los datos del nuevo Libro no han sido guardados.</p>
                            <p>Vuelta a intentarlo.</p>
                        </div>
            ...
            <h2 class="text-center py-3 text-white book-title"><i class="fas fa-plus-circle text-white"></i> Agregar Libro en Base de Datos</h2>
            <div class="main-bg py-5">
                <form class="row g-3 col-lg-6 col-xs-12 m-auto form-add-book" action="../controller/nuevoLibro.php" method="post">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <label for="newYear" class="form-label">Año</label>
                        <input type="number" class="form-control" id="newYear" name="newYear" required>
                    </div>
                    <div class="col-12">
                        <label for="newCountry" class="form-label">País</label>
                        <input type="text" class="form-control" id="newCountry" name="newCountry" required>
                    </div>
                    <div class="col-12">
                        <label for="newLanguage" class="form-label">Idioma</label>
