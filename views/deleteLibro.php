...
<body>
    ...
    <main class="container py-5">
        ...
        $libroBorrar = $libroDAO->getLibroPorID($id);
        ?>
        ...
        <div class="container">
            ...
            <div class="py-5">
                <div class="container box-delete col-lg-6 col-xs-12">
                    <h5 class="text-center my-5">¿Está seguro que desea eliminar el libro '<strong><?php echo $libroBorrar[0]->getTitle(); ?></strong>'?</h5>
                    <div class="my-5 text-center">
                        <form class="d-inline-block" action="../controller/deleteLibroController.php" method="post">
                            <input type="hidden" class="form-control" id="deleteId" name="deleteId" value="<?php echo $id; ?>">
                            <button type="submit" class="btn btn-dark mx-4 my-2">Confirmar</button>
                        </form>
                        <a href="./listadoLibros.php" class="btn btn-danger mx-4 my-2">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
