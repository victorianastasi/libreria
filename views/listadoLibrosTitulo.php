...
<body>
    ...
    <main class="container py-5">
        ...
        <div class="container">
            ...
            <?php
            echo "<h4>Busqueda por Título: ' " . $_POST['seachBookTitle'] . " '</h4>";
            ?>
            ...
            $seachBookTitle = $_POST['seachBookTitle'];

            $listLibrosTitulo = $libroDAO->listarLibrosporTitulo($seachBookTitle);
            if (empty($listLibrosTitulo)) {
                ...
                echo "</thead>";
                echo "<tbody>";
                foreach ($listLibrosTitulo as $libro) {
                    echo "<tr>";
